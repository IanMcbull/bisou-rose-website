...
function Contact() {
  return (
    <div className="min-h-[100vh] grid grid-cols-1 md:grid-cols-2 container mx-auto gap-12">
      <div className="flex flex-col justify-center gap-10">
        ...
        <form>
            <div className="flex gap-12">
                ...
                <input type="text" placeholder="Last Name" className="p-4 border-2 border-black"/>
            </div>
